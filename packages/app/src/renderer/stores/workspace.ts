...
export type PanelType = 'terminal' | 'browser' | 'notes' | 'app' | 'workflow' | 'timer' | 'ports' | 'process' | 'env' | 'http' | 'whiteboard' | 'regex' | 'data' | 'encoder' | 'cron' | 'diff' | 'color' | 'epoch' | 'uuid' | 'numbase';
