...
export const PROGRESSION_NODES: ProgressionNode[] = [
  ...
  // ─── Lane 7: Passives (permanent stats & mechanics) ───
  {
    id: "passive_attack_1",
    name: "Sharp Pointers",
    description: "+1 attack to all units (stacks up to 3×)",
    emoji: "🔪",
    category: "stat_boost",
    cost: 5,
    prerequisites: [],
  ...
  },
  {
    ...
    description: "+10 HP to all units (stacks up to 3×)",
    emoji: "💪",
    category: "stat_boost",
    cost: 5,
    prerequisites: [],
  ...
  },
  {
    ...
    category: "stat_boost",
    cost: 15,
    prerequisites: ["passive_attack_1", "passive_hp_1"],
  ...
  },
  {
    ...
    category: "mechanic",
    cost: 50,
    prerequisites: ["unlock_pair_programmer"],
